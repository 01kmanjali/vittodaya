...
export default function AdminEVLoanPage() {
  const { data: loans = [], isLoading } = useLoanApplications({ type: "ev" });
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold" style={{ color: "var(--text-primary)" }}>EV Loans</h1>

  ...
  return (
    <>
      ...
      <section className="text-white py-16 lg:py-24 overflow-hidden relative" style={{ background: "#0a3460" }}>
        ...
        {/* Left-to-right gradient: opaque navy left → transparent right */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {highlights.map((item, i) => (
              <Card key={item.title} className={`hover-lift animate-fade-up stagger-${i + 1} border-0 shadow-sm`}>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {homeProducts.map((p, i) => (
                <Card key={p._id} className={`hover-lift animate-fade-up stagger-${i + 1} group overflow-hidden border-0 shadow-sm`}>
                  {p.image && (
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="group relative animate-slide-right rounded-2xl overflow-hidden shadow-lg cursor-pointer">
              <Image
                src="/home-about.png"
      ...
      {/* ── 4. LOAN PRODUCTS (dynamic) ───────────────────────────────────── */}
      {loanProducts.length > 0 && (
        <section className="py-16 relative overflow-hidden" style={{ background: "var(--bg-light)" }}>
          {/* Decorative accent images — visible side panels on large screens */}
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div className="animate-fade-up">
              <Badge variant="outline" className="mb-3 text-blue-700 border-blue-200">Loan Against Property</Badge>
              ...
              <Button asChild className="text-white" style={{ background: "linear-gradient(135deg, var(--secondary) 0%, var(--secondary-light) 100%)" }}>
                <Link href="/loans/lap">Explore LAP <ArrowRight className="h-4 w-4 ml-1" /></Link>
              </Button>
            </div>
            <div className="space-y-4 animate-slide-right">
              {lapFeatures.map((f, i) => (
                <div key={f.title} className={`flex gap-3 animate-fade-up stagger-${i + 1}`}>
                  <CheckCircle2 className="h-5 w-5 shrink-0 mt-0.5" style={{ color: "var(--secondary)" }} />
                  <div>
      ...
      <section className="py-16" style={{ background: "var(--bg-light)" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="group relative rounded-2xl overflow-hidden shadow-lg animate-fade-up cursor-pointer">
              <Image
                src="/home-why.jpg"
            ...
            <div className="animate-slide-right">
              ...
              <div className="space-y-4">
                {whyUs.map((item, i) => (
                  <div key={item.title} className={`flex gap-4 items-start animate-fade-up stagger-${i + 1}`}>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="group relative rounded-2xl overflow-hidden shadow-lg animate-slide-right cursor-pointer">
              <Image
      ...
      <section className="py-16" style={{ background: "var(--bg-light)" }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center animate-fade-up">
          ...
          <blockquote className="text-lg font-medium leading-relaxed mb-6" style={{ color: "var(--text-primary)" }}>
            "At Vittodaya, we believe financial growth should be accessible, transparent, and
            ...
            ethical, and empowering support to build a stronger financial future."
          </blockquote>
